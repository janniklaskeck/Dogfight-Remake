...
public class PlaneState extends BasicGameState {
	...
	plane_leftY = Var.dim_chosen.height - Var.dim_chosen.height * 0.15f;
	plane_rightX = Var.dim_chosen.width * 0.25f;
	plane_rightY = Var.dim_chosen.height - Var.dim_chosen.height * 0.15f;
	plane_nameX = Var.dim_chosen.width * 0.15f;
	plane_nameY = Var.dim_chosen.height - Var.dim_chosen.height * 0.15f;
	wpn1_leftX = 0;
	wpn1_leftY = 0;
	wpn1_rightX = 0;
	wpn1_rightY = 0;
