...
public class ModernTestPlane extends Modern {
	...
	private final static int MIN_SHOOT_DELAY_GUN = 100;
	private final static int RELOAD_DELAY_GUN = 2500;
	...
	private final int PRIM_AMMO = 20;
	private final int SEC_AMMO = 4;
	private int counter_rocket = SEC_AMMO;
	private int counter_gun = PRIM_AMMO;
	private boolean broken;
	private double hspeed, vspeed;

	public ModernTestPlane(int id, double xpos, double ypos, double angle,
	...
	public Weapons shoot_gun() {
		...
		return new Weapons(x, y, angle, 7, WeaponTypes.GUN, Render.img_bullet1, id);
	}
	...
	public Weapons shoot_missile() {
		...
		return new Weapons(x, y, angle, 35, WeaponTypes.GUIDED_AIR, Render.img_bullet1, id);
	}
