...
public enum PlaneTypes {
	...
	NORMAL("Normal", 100, 1, 0.01f, 0.12f, 1, WeaponTypes.GUN, WeaponTypes.GUN,
			WeaponTypes.GUIDED_AIR, WeaponTypes.GUIDED_GROUND, Var.img_plane1), 
	FAST("Fast", 75, 1.25f, 0.01f, 0.12f, 0.75f, WeaponTypes.GUN,
			WeaponTypes.GUN, WeaponTypes.BOMB, WeaponTypes.BOMB, Var.img_plane2), 
