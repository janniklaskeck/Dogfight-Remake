...
/**
 * Class for World-War 2 plane types
 * @author Jan-Niklas
 *
 */
public class WW2 extends Planes {
	...
	public WW2(int id, double xpos, double ypos, double angle,
	...
	public Weapons shoot_secondary(WeaponTypes type) {
		...
		if (type == WeaponTypes.UNGUIDED) {
			...
			return new Weapons(x, y, angle, 5, WeaponTypes.UNGUIDED, Render.img_bullet1, id);
