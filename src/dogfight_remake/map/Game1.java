...
public class Game1 extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		SpriteSheet sheet = new SpriteSheet(
				"/src/dogfight_remake/map/map_test/collision.png", 16, 15);
		...
		playerPoly = new Polygon(new float[] { playerX, playerY, playerX + 15,
				playerY, playerX + 15, playerY + 16, playerX, playerY + 16 });
	}
	...
	public static void main(String[] argv) throws SlickException {
		AppGameContainer container = new AppGameContainer(new Game1(), 1680,
				1050, false);
		container.start();
	}
}